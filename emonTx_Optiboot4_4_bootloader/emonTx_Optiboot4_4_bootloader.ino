//Arduino Optiboot 4.4 bootloader with emonTx CT single CT
//Based on isp_repair by JeeLabs.org customised by Glyn Hudson openenergymonitor.org

//Extended fuse value has been changed to give a lower Brown Out Detection voltage
//this should allow emonTx to work on battery voltages less than 2.7V
...
#endif
#define FUSE_EXTENDED   0x05 //0x06 default Arduino BOD voltage 2.7V - 0x05 lower BOD of 1.8V
//http://www.openenergymonitor.org/emon/node/342
