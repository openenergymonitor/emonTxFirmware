/*
 EmonTx CT123 + Voltage + Temperature example
 
 An example sketch for the emontx module for
 CT and AC voltage sample electricity monitoring. Enables real power and Vrms calculations. And suports temperature DS18X20 sensor detection and temperature adquisition.
 
 Part of the openenergymonitor.org project
 Licence: GNU GPL V3
 
 Authors: Glyn Hudson, Trystan Lea, Marc Rodriguez-Estivill
...
#define RF_freq RF12_868MHZ                                                // Frequency of RF12B module can be RF12_433MHZ, RF12_868MHZ or RF12_915MHZ. You should use the one matching the module you have.433MHZ, RF12_868MHZ or RF12_915MHZ. You should use the one matching the module you have.
