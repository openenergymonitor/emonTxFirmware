    ...
    {  
      if (polarityOfLastSampleV != POSITIVE)
      {
        ...
        {         
          ...
          joules_CT1 += tx_data.power_CT1;
          joules_CT2 += tx_data.power_CT2;
          joules_CT3 += tx_data.power_CT3;
          joules_CT4 += tx_data.power_CT4;
          
          // Positive energy accumulation (directional)
          ...
          // Negative energy accumulation (directional)
