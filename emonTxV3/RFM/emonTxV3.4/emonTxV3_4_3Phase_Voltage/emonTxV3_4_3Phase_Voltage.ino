...
// #define USA           //enable USA voltage calibration for use with USA AC-AC plugs
...
#ifdef USA
	double Vcal = 135.0;                             // USA Calibration constant for voltage input
#else
	double Vcal = 276.9;                             // UK/EU Calibration constant for voltage input
#endif
...
void setup()
{
	...
	#ifdef USA
			Serial.println("USA calibration");
	#endif
