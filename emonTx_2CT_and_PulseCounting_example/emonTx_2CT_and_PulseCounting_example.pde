...
//--------------------------------------------------------------------------------------
//Interrupt pulse counting and two CT sensors
...
// CT input on CT channel 1 and 2 (middle and bottom jack on RHS)
...
{  
   //--------------------------------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------------------------------
          ...
          emontx.ct1=int(ch1.emon( CT1_INPUT_PIN, cal1, RMS_VOLTAGE, NUMBER_OF_SAMPLES, CT_BURDEN_RESISTOR, CT_TURNS, supplyV));
          emontx.ct2=int(ch2.emon( CT2_INPUT_PIN, cal2, RMS_VOLTAGE, NUMBER_OF_SAMPLES, CT_BURDEN_RESISTOR, CT_TURNS, supplyV));
    //--------------------------------------------------------------------------------------------------
