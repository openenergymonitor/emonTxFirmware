...
print' '
print 'OpenEnergyMonitor emonTx V3.4 & RFM69Pi V3.1 Automated Upload & RF test 11/02/2015'
print ' ' 
print 'Select Upload:'
...
while(1):
	print ' ' 
	print 'Enter (b) for emonTx V3.4 RFM12B or (w) for emonTx V3.4 RFM69CW ' 
	nb = raw_input('Or (r) for RFM69Pi (both freq)  >')
	#print ('Number%s \n' % (nb))
        print(nb)
	...
	if nb=='b': 
		...
		cmd = 'sudo avrdude -V -u -p atmega328p -c avrispmkII -P usb -e -Ulock:w:0x3F:m -Uefuse:w:0x05:m -Uhfuse:w:0xDE:m -Ulfuse:w:0xFF:m -U flash:w:/home/pi/emonTxFirmware/emonTxV3/RFM12B/emonTxV3_4_RFM12B_DiscreteSampling/emonTxV3_4_RFM12B_DiscreteSampling_433_bootloader.cpp.hex:i  -Ulock:w:0x0F:m'
